//===================================================================================================================
// hw-74hc193.hh -- This header file defines a 74HC38 3:8 Demultiplexer
//
...
//
// -- This class implements a 74HC138 Demultiplexer
//    ---------------------------------------------
class HW_74HC138_t : public QObject {
    Q_OBJECT
...
private:
    TriState_t pins[16+1];


public:
    HW_74HC138_t(void);
    virtual ~HW_74HC138_t() {};
